...
- Visible "since [date]" labeling in the UI, showing exactly how long each stat has been tracked
- Custom date-range filtering (this week / this month / this year / all time)
